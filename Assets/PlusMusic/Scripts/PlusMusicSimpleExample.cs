...
namespace PlusMusic
{
    public class PlusMusicSimpleExample : MonoBehaviour
    {
        ...
        public void PlayLowTemplate()
        {
            transition.tag = PlusMusic_DJ.PMTags.low_template;
            PlusMusic_DJ.Instance.PlaySoundPM(transition);
        }
        public void PlayHighTemplate()
        {
            transition.tag = PlusMusic_DJ.PMTags.high_template;
            PlusMusic_DJ.Instance.PlaySoundPM(transition);
        }
